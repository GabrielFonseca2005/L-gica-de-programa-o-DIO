...
class ItemMagico {
    // Construtor que recebe os atributos do item
    ...
    // Função que calcula o dano com base no tipo do item
    calcularDano() {
  ...
  // Criação do objeto ItemMagico com base nas entradas do usuário
